...
inference_data = pd.read_csv('../datasets/full_dataset/corresponding_reviews.csv')
...
informative_reviews.to_csv('../datasets/full_dataset/filtered_corresponding_reviews.csv.csv', index=False)
